        ...
        <div className="flex items-center justify-between">
          ...
          <div className="header-button">
            <div className="hidden lg:flex lg:items-center gap-x-2">
              ...
              <button className="flex items-center text-white justify-center rounded-md bg-[#6738EE] px-6 py-2.5 font-semibold hover:shadow-lg hover:drop-shadow transition duration-200">
                Login
              </button>
            </div>
          </div>
